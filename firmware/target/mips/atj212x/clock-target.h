...
/* Clock Sources  */
#define ATJ212X_CLK_MAIN           0
#define ATJ212X_CLK_PLLA           1
#define ATJ212X_CLK_PLLB           2
#define ATJ212X_CLK_PLLC           3
#define ATJ212X_CLK_PCLK           4 /* Synthesized PCLK frequency */

/** ************ Change these to reconfigure clocking scheme *******************/
#if CONFIG_CPU == ATJ2127
 ...
 */
#define ATJ212X_PLLA_FREQ        480000000   /* allows 44.1kHz with 0.04% error*/
#define ATJ212X_PLLA_SETTING     0x155F
...
#define ATJ212X_DRAM_FREQ        96000000    /* Initial DRAM frequency  */
...
#define CPUFREQ_MAX              ATJ212X_FLLA_FREQ
#define CPUFREQ_DEFAULT          38400000
#define CPUFREQ_NORMAL           CPUFREQ_DEFAULT

/* FCLK */
#define ATJ212X_FCLK_SEL          AS3525_CLK_PLLA
#define ATJ212X_FCLK_POSTDIV      (CLK_DIV((AS3525_PLLA_FREQ*(8-AS3525_FCLK_PREDIV)/8), AS3525_FCLK_FREQ) - 1) /*div=1/(n+1)*/
...
/* MCLK */
#define ATJ212X_MCLK_SEL          AS3525_CLK_PLLA
#define ATJ212X_MCLK_FREQ         AS3525_PLLA_FREQ

/* PCLK */

#if CONFIG_CPU == AS3525

#define ATJ212X_PCLK_SEL          AS3525_CLK_PLLA
         /*unable to use AS3525_PCLK_DIV1 != 0 successfuly so far*/
#define ATJ212X_PCLK_DIV1         (CLK_DIV(AS3525_DRAM_FREQ, AS3525_PCLK_FREQ) - 1)/* div = 1/(n+1)*/ 
#define ATJ212X_PCLK_DIV0         (CLK_DIV(AS3525_PLLA_FREQ, AS3525_DRAM_FREQ) - 1) /*div=1/(n+1)*/
#else

#define ATJ212X_PCLK_SEL          ATJ212X_CLK_FCLK
#define ATJ212X_PCLK_DIV0         (CLK_DIV(AS3525_FCLK_FREQ, AS3525_DRAM_FREQ) - 1) /*div=1/(n+1)*/

#endif /* CONFIG_CPU */

   /* PCLK as Source */
  #define ATJ212X_DBOP_DIV        (CLK_DIV(AS3525_PCLK_FREQ, AS3525_DBOP_FREQ) - 1) /*div=1/(n+1)*/
  #define ATJ212X_I2C_PRESCALER   CLK_DIV(AS3525_PCLK_FREQ, AS3525_I2C_FREQ)
  #define ATJ212X_I2C_FREQ        400000
  #define ATJ212X_SD_IDENT_DIV    ((CLK_DIV(AS3525_PCLK_FREQ, AS3525_SD_IDENT_FREQ) / 2) - 1)
  #define ATJ212X_SD_IDENT_FREQ   400000      /* must be between 100 & 400 kHz */
  #define ATJ212X_SSP_PRESCALER   ((CLK_DIV(AS3525_PCLK_FREQ, AS3525_SSP_FREQ) + 1) & ~1)    /* must be an even number */
  #define ATJ212X_SSP_FREQ        12000000

#define ATJ212X_IDE_SEL           AS3525_CLK_PLLA           /* Input Source   */
#define ATJ212X_IDE_DIV           (CLK_DIV(AS3525_PLLA_FREQ, AS3525_IDE_FREQ) - 1)/*div=1/(n+1)*/
